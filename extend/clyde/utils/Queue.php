 ...
 * @method $this delay(int $delay) 重新发布时延迟执行秒数
 * @method $this queueName(string $queueName) 队列名称
...
class Queue
{
     ...
     * @var array
     */
    protected $rules = ['do', 'data', 'errorCount', 'job', 'secs', 'delay', 'queueName', 'log'];
     ...
     * @return $this
     */
    public function __call($name, $arguments): Queue
    {
